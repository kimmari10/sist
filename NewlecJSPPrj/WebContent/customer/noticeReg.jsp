	...
	<!-- content 부분 -->
			<section id="content" class="notice-detail">
		        ...
		        <section class="bbs-detail">
			        <h1 class="hidden">공지 내용</h1>
			        <form action="" method="post">
			        	<fieldset>
			        		<legend class="hidden">공지 사항 필수 입력 필드</legend>
					        <dl class="cf">       	
					        	...
					        	<dt class="hidden"><label for="content">공지내용</label></dt>
					        	<dd class="content">					        		
					        		<div class="row">
					        			<span class="title">a</span>
					        			<span class="data"><textarea name="content"></textarea></span>
					        		</div>
					        	</dd>
				        	...
				        	<p>
				        		<input class="button btn-reg" type="submit" value="등록" />
				        		<a class="button btn-cancel" href="notice.jsp">취소</a>
				        	</p>
				        </fieldset>       
			        </form>
		        </section>		        
