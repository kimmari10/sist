...
<%
	...
	List<Notice> list = new NLNoticeDao().getNotices(pnum);
...
<%for(Notice n : list){ %>
							<tr>
								<td class="seq"><%=n.getSeq()%></td>
								<td class="title"><a href="noticeDetail.jsp?seq=<%=n.getSeq()%>"><%=n.getTitle()%></a></td>
...
<%} %>
					...
					<div id="pager-wrapper" class="margin-small">
						<div class="pager clear">
							...
							<ul>
								<li>
									<a class="strong" href="notice.jsp?p=1">1</a>
								</li>
								<li>
									<a href="notice.jsp?p=2">2</a>
								</li>
								<li>
									<a href="notice.jsp?p=3">3</a>
								</li>
								<li>
									<a href="notice.jsp?p=4">4</a>
								</li>
								<li>
									<a href="notice.jsp?p=5">5</a>
								</li>
							</ul>
							<p id="btnNext">
