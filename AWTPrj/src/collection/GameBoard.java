...
public class GameBoard extends Canvas implements Runnable{
	...
	private GCollection<EnemyFighter> enemies;
...
//		enemies.reset(); // 순환 알고리즘에 필요함. idx초기화함수
		
//		ObjectIterator it = list.iterator();
		
		for(EnemyFighter en : enemies)
			en.paint(g1);
		
		
		/*while(enemies.hasNext())
			((EnemyFighter)enemies.next()).paint(g1);*/
